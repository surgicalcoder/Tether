...
//    /// </summary>
//    public class IOMetricProvider : IMetricProvider
//    {
...
//            var instanceNames = searcher.Get().Cast<ManagementObject>().Select(e => e["Name"].ToString()).Where(f=>!f.ToLowerInvariant().StartsWith("harddiskvolume")).ToArray();
...
//            {
//                var tags = new Dictionary<string, string> {{"drive", drive.DriveName}};
